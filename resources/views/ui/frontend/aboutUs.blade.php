					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{asset('ui/frontend/assets/aboutUs.blade.php')}}" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
								...
								<li class="menu-item">
									<a href="{{asset('ui/frontend/contact-us.html')}}" link-term mercado-item-title">Contact Us</a>
								</li>								
							</ul>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><a href="{{asset('ui/frontend/contact-us.html')}}" class="link"> <span>Contact us</span></a></li>
				</ul>
			</div>
		</div>
					...
					<div class="our-staff">
						<div 
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="LEONA">
										<figure><img src="{{asset('ui/frontend/assets/images/member-leona.jpg')}}">
									</a>
								</div>
								<div class="info">
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="LUCIA">
										<figure><img src="{{asset('ui/frontend/assets/images/member-lucia.jpg')}}">
									</a>
								</div>
								<div class="info">
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="NANA">
										<figure><img src="{{asset('ui/frontend/assets/images/member-nana.jpg')}}">
									</a>
								</div>
								<div class="info">
									<b class="name">NANA</b>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="BRAUM">
										<figure><img src="{{asset('ui/frontend/assets/images/member-braum.jpg')}}">
									</a>
								</div>
								<div class="info">
				...
				<div class="container">
					...
					<div class="coppy-right-item item-right">
						<div class="wrap-nav horizontal-nav">
							<ul>
								<li class="menu-item"><a href="{{asset('ui/frontend/aboutUs.blade.php')}}" class="link-term">About us</a></li>								
